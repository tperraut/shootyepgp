...
L:RegisterTranslations("enUS", function()
  return {
    ...
    ["Winning Mainspec Bid: %s (%.03f PR) with %s"] = true,
...
Results will print here when done.]],
    ...
    ["|cffFFF533|Hshootybid:1:$ML|h[MS/MIN]|h|r"] = true,
    ["|cffFFa733|Hshootybid:2:$ML|h[MS/NEED]|h|r"] = true,
    ["|cffFF3333|Hshootybid:3:$ML|h[MS/ALLIN]|h|r"] = true,
    ["|cff009900|Hshootybid:4:$ML|h[OS/GREED]|h|r"] = true,
    ["Bids"] = true,
    ...
    ["allin:|cff32cd32%d|r need:|cff32cd32%d|r min:|cff32cd32%d|r gp_os:|cff20b2aa%d|r"] = true,
    ["PR: allin:|cffff0000%.02f|r(%.02f) need:|cffff0000%.02f|r(%.02f) min:|cffff0000%.02f|r(%.02f) os:|cffff0000%.02f|r(%.02f)"] = true,
    ...
    ["Whisper %s a +MIN, +NEED, +ALLIN for %s (mainspec)"] = true,
    ["Whisper %s a - for %s (offspec)"] = true,
    ["Whisper %s a +MIN, +NEED, +ALLIN or - for %s (mainspec or offspec)"] = true,
    ["Click $MS_MIN or $MS_NEED or $MS_ALLIN or $OS for %s"] = true,
    ["or $OS "] = true,
    ["$MS or "] = true,
    ...
    ["Awarding %d GP to %s%s. (Previous: %0.6f, New: %0.6f)"] = true,
